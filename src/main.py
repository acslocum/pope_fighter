...
def reset_game():
    ...
    fighter_1 = Fighter(1, 0.1 * SCREEN_WIDTH, 310, fighter_height_ratio * SCREEN_HEIGHT, False, 'assets/images/pope1', pope1_game_sounds, left_pope)
    fighter_2 = Fighter(2, 0.9 * SCREEN_WIDTH, 310, fighter_height_ratio * SCREEN_HEIGHT, True, 'assets/images/pope2', pope2_game_sounds, right_pope)
    if game_debug:
